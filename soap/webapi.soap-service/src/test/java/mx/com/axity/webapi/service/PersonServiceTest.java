...
class PersonServiceTest {
  ...
  void testGetPerson_RecordNotFound() {
    ...
    BusinessException exception =
        Assertions.assertThrows(BusinessException.class, () -> personService.getPerson(personId));

    // Verify the exception details
    Assertions.assertEquals(100, exception.getCode());
    Assertions.assertEquals("Record not found", exception.getMessage());
    Assertions.assertEquals("The person does not exists.", exception.getDetails());
  ...
  void testUpdatePerson_RecordNotFound() {
    ...
    // Call the service method and assert that it throws a BusinessException
    BusinessException exception =
        Assertions.assertThrows(BusinessException.class, () -> personService.updatePerson(personDTO));
  ...
  void testDeletePerson_RecordNotFound() {
    ...
    // Call the service method and assert that it throws a BusinessException
    BusinessException exception =
        Assertions.assertThrows(BusinessException.class, () -> personService.deletePerson(personId));
  ...
  void testDeletePerson_RecordAlreadyDeleted() {
    ...
    Assertions.assertEquals("Record already deleted", exception.getMessage());
    Assertions.assertNull(exception.getDetails());
